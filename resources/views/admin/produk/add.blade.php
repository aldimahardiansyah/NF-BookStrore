...
<form action="/produk/create" method="POST">
    <div class="flex-container row"> 
        ...
        <div class="col-sm-6 m-3" style="padding:0">

                <div class="row-md" class="mt-5"> 
                    <h4 class="text-blue fw-bold">Tambah Produk</h4> 
                </div>
                ...
                <div class="row-md-6 p-3 my-3 border rounded" style="background-color:white">
                    ...
                    <form style="margin-top:20px">
                        <div class="form-group">
                            <label for="formGroupExampleInput" style="margin-left:10px;margin-bottom:5px">Judul</label>
                        ...
                        <div class="form-group" style="margin-top:15px">
                            ...
                            <textarea name="deskripsi" type="text" class="form-control" id="formGroupExampleInput2"></textarea>
                        </div>
                    </form>
                </div>
                            ...
                            <div class="form-group">
                                <div class="dropzone-wrapper">
                                    <div class="dropzone-desc">
                                        ...
                                        <p style="font-weight:bold;color:#333;font-size:13px;margin-top:10px">Drag and drop/choose foto</p>
                                    </div>
            ...
            <div class="col-sm-4 m-5" style="padding:0">
